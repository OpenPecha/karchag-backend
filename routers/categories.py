...
from schemas import (MainCategoryResponse, MainCategoryCreate, SubCategoryUpdate,
...
# GET Endpoints
@router.get("/", response_model=List[MainCategoryWithSubCategories], tags=["Categories"])
...
@router.get("/{category_id}/subcategories", response_model=List[SubCategoryResponse], tags=["Sub-Categories"])
